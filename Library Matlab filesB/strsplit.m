function [split,numpieces]=strsplit(string,delimiters)
%strsplit    Splits string into pieces.
%   strsplit(STRING,DELIMITERS) returns a cell array with the pieces
%   of STRING found between any of the characters in DELIMITERS.
%
%   [SPLIT,NUMPIECES] = strsplit(STRING,DELIMITERS) also returns the
...
%      STRING = 'ab_c,d,e fgh'
%      DELIMITERS = '_,'
%      [SPLIT,NUMPIECES] = strsplit(STRING,DELIMITERS)
%      SPLIT = 'ab'    'c'    'd'    'e fgh'
%      NUMPIECES = 4
%
%   See also strjoin, STRTOK
%
