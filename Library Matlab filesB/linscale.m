...
% Create linearly spaced vector with npts elements ranging from x0 to x1. 
% Similar to linspace, but with a different default value of npts and
% an orientation flag.  
% Implemented for compatibility with logscale.
%
